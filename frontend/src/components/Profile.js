  ...
  render (){
    ...
    return(
      <div>
        ...
        <span className="color">Name: Bell{} </span><br /><br />
        <span className="color">Age: 22{} </span><br /><br />
        <span className="color">About Me: I love to read! My favorite are about "Far off places, daring swordfights, magic spells, a prince in disguise" {} </span><br /><br />
        <Link to="/editProfile">
